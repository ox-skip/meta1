...
export const SUPPORTED_EVM_STOCK_CHAIN_LABEL = "ethereum, base, arbitrum, optimism, polygon, BNB, Arc testnet, Base Sepolia, BNB Testnet, Arbitrum Sepolia, and Polygon Amoy";
